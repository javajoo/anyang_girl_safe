...
$(document).ready(function(){
	$('#excel_download_btn').click(function() {
		var url = "/excelDownload/oldPeople.getUserLogList/action.do";
...
function reload(){
	...
	$('#actionLogList_table').datagrid({
	    url:'/selectList/oldPeople.getUserLogList/action.do',
	    pagination:true,
	    pageSize:12,
	    ...
	    columns:[[
			...
			{field:'adminName',title:'관리자 이름',width:'10%',align:'center'},
			{field:'userKey',title:'단말기번호',width:'15%',align:'center'},
			{field:'userName',title:'이름',width:'10%',align:'center'},
